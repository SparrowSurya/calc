...
def raw_token_view(tokens: Iterable[Token], color: bool = False) -> str:
    """raw view of the tokens"""
    return "\n".join(map(repr, tokens))


def tabular_token_view(
    tokens: Iterable[Token], color: bool = False, fmt: str = _fmt_tabular()
):
...
def token_view(
    tokens: Token, raw: bool = False, title: str = None, color: bool = False
) -> str:
...
def ast_view(
    root: Node, raw: bool = False, title: str = None, color: bool = False
) -> str:
...
def raw_ast_view(root: Node, color: bool = False) -> str:
    """raw ast view of expression"""
    return repr(root)


def preety_ast_view(root: Node, color: bool = False) -> str:
